                                            ...
                                            <div class="product-details-content col-6 pr0">
                                                ...
                                                @if (isset($item->additional['attributes']))
                                                    @foreach ($item->additional['attributes'] as $attribute)
                                                        <div
                                                            class="row col-12 no-padding no-margin display-block item-attribute">
                                                ...
                                                <div class="no-padding cursor-pointer fs16 item-actions">
                                                    ...
                                                    <div class="d-inline-block">
                                                        <a
                                                            ...
                                                            <span
                                                                class="align-vertical-super">{{ __('shop::app.checkout.cart.remove') }}</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
